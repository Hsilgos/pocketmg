...
public:
  ...
  bool loadMono(unsigned int width,
                unsigned int height,
  ...
  bool loadColor16(unsigned int width,
                   unsigned int height,
                   const unsigned char* src_begin,
                   unsigned long data_size,
                   const Palette& pallete,
  ...
  bool loadColor256(unsigned int width,
                    unsigned int height,
                    const unsigned char* src_begin,
                    unsigned long data_size,
                    const Palette& pallete,
  ...
  bool loadColor16_XXX(unsigned int width,
                       unsigned int height,
    ...
    for (unsigned short y = 0; y < height; ++y) {
      ...
      for (unsigned short x = 0; x < width; ++x) {
        ...
        dst[0] = static_cast<unsigned char>(((src & mask_red) >> r_off) * r_mult);
        dst[1] = static_cast<unsigned char>(((src & mask_green) >> g_off) * g_mult);
        dst[2] = static_cast<unsigned char>(((src & mask_blue) >> b_off) * b_mult);
  ...
  bool loadColor16_555(unsigned int width,
                       unsigned int height,
                       const unsigned char* src_begin,
                       unsigned long data_size,
                       const Palette& /*pallete*/,
  ...
  bool loadColorFull(unsigned int width,
                     unsigned int height,
                     const unsigned char* src_begin,
                     unsigned long data_size,
  ...
  bool loadColorFull24(unsigned int width,
                       unsigned int height,
                       const unsigned char* src_begin,
                       unsigned long data_size,
                       img::Image& decoded) {
  ...
  bool loadColorFull32(unsigned int width,
                       unsigned int height,
                       const unsigned char* src_begin,
                       unsigned long data_size,
                       img::Image& decoded) {
