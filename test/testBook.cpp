...
public:
  ExplorerTestFixture()
    : file_system_(new TestFileSystem), archiver_(file_system_.get()) {}
...
std::vector<fs::FilePath> CallFixUp(const char* root,
...
void DoCheckFixUp(const std::vector<fs::FilePath>& files,
                  const char* path1 = 0,
                  const char* path2 = 0,
                  const char* path3 = 0,
                  const char* path4 = 0,
